      ...
      <header className="px-8 py-6 flex items-center justify-between bg-white border-b border-border shadow-sm">
        ...
        {user && (
          <div className="flex items-center gap-4">
            ...
            <Link href={role === 'admin' ? '/admin-new' : '/dashboard'}>
      ...
      <main className="flex-1 flex flex-col items-center px-6 pt-16 pb-20 max-w-7xl mx-auto w-full text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-6xl">
          ...
          <div className="bg-white p-10 rounded-card border border-border shadow-card flex flex-col items-start text-left group hover:bg-primary-light transition-colors">
            ...
            <Link href="/admin-new" className="inline-flex items-center text-primary font-bold text-lg hover:gap-2 transition-all">
